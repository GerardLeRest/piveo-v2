...
DOSSIER_ICONES = Path(__file__).resolve().parent.parent / "ressources" / "fichiers" / "icones"
...
class FenetrePrincipale(QMainWindow):
    ...
    def __init__(self, configuration_json, connecteur_bdd, parent=None):
        ...
        self.zone_droite_haute.desactiver_boutons_champs()
          # définition des QAction communes
    ...
    def barre_outils(self) -> None:
        ...
        # groupement des 4 boutons de gauche - fonctionne comme des radios
        ...
        # associer les icones aux Qaction
        self.act_lecture.setIcon(QIcon(str(DOSSIER_ICONES / "oeil.svg")))
        self.act_deviner.setIcon(QIcon(str(DOSSIER_ICONES / "oeil_cache.svg")))
        self.act_ecrit.setIcon(QIcon(str(DOSSIER_ICONES / "crayon.svg")))
        self.act_recherche.setIcon(QIcon(str(DOSSIER_ICONES / "question.svg")))
        self.act_aleatoire.setIcon(QIcon(str(DOSSIER_ICONES / "aleatoire.svg")))
        # rattacher les Qactions à la barre d'outils
        ...
        # icone "lecture" rendu vérifiable
