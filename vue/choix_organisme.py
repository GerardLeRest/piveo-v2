...
from PySide6.QtWidgets import (
    QWidget, QVBoxLayout, QLabel, QRadioButton, QPushButton, QScrollArea
)
...
class ChoixOrganisme(QWidget):
    ...
    def interface(self) -> None:
        ...
        # Zone RGPD avec scroll (QLabel + QScrollArea)
        scroll_rgpd = QScrollArea()
        scroll_rgpd.setWidgetResizable(True)
        scroll_rgpd.setFixedHeight(220)
        scroll_rgpd.setStyleSheet("QScrollArea {background-color: #f9f9f9; border: 1px solid #999;}")
        label_rgpd = QLabel(
            "<b>Protection des données</b><br><br>"
        ...
        label_rgpd.setStyleSheet("QLabel {background-color: #f9f9f9; color: black; font-size: 12px; padding: 5px;}")
        ...
        bouton.setStyleSheet("""
            QPushButton {background-color: #76aeba; color: white; border-radius: 12px; padding: 5px 10px; font-weight: bold;}
            QPushButton:hover {background-color: #66a0b0;}
        """)
